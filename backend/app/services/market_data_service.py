        ...
        try:
            ...
            try:
                ...
                if self.prediction_repo.prediction_exists_for_date(next_day):
                    ...
                    # No stored prediction available - this should be generated by background task
                    # Log warning but don't generate here
                    logger.warning(
                        f"No stored prediction found for {next_day}. Prediction should be generated by background task at market open.")
                    predicted_price = None
                    prediction_method = None
            except Exception as e:
